...
| [BE-34](BE-34-sample-tags.md) | `SampleTag`: tags semânticas por amostra — mecânica desacoplada (sistema + usuário), BE-26/FE-34/FE-37 viram consumidores | Não iniciado |
