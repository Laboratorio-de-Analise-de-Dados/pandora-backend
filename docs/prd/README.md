...
| [BE-19](BE-19-workspaces-templates-analise.md) | Workspaces/templates: estratégia reutilizável entre experimentos | Parcial — derivação de análise implementada (ADR-0021); template persistido segue visão |
...
| [BE-34](BE-34-sample-tags.md) | `SampleTag`: tags semânticas por amostra — mecânica desacoplada (sistema + usuário), BE-26/FE-34/FE-37 viram consumidores | Implementado — PRs #113/#114, deploy v0.4.0 |
