...
| Dívida: validação inline → serializers (ADR-0009) + auditoria de stats | `*/serializers.py`, `*/views.py`, `*/tests.py`, `utils/density.py`, `analytics/tasks.py` | `refactor/inline-validation-serializers` | devin | 2026-09 |
